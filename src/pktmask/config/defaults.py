...
Centralized management of all configuration defaults for easy maintenance and updates.
"""

# User interface defaults (using standard GUI naming)
DEFAULT_UI_CONFIG = {
    "window_width": 1200,
    "window_height": 800,
...
DEFAULT_LOGGING_CONFIG = {
    ...
    "enable_protocol_parsing_logs": False,  # Default disable protocol stack parsing detailed logs
}
...
def get_validation_constraint(key: str):
    """Get validation constraint values"""
