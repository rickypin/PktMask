...
class ErrorRecoveryHandler:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.logger.info(f"错误处理器初始化: 最大重试={self.max_retry_attempts}, "
    ...
    def retry_operation(self, operation: Callable, 
                       max_attempts: Optional[int] = None,
                       delay: Optional[float] = None,
                       error_category: ErrorCategory = ErrorCategory.PROCESSING_ERROR) -> Any:
        """重试操作
        ...
        for attempt in range(max_attempts):
            try:
                ...
                if attempt < max_attempts - 1:
                    ...
                    self.handle_error(e, ErrorSeverity.MEDIUM, error_category, 
                    ...
                    self.handle_error(e, ErrorSeverity.HIGH, error_category,
