...
class FallbackHandler:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.logger.info(f"降级处理器初始化: 默认模式={self.default_fallback_mode.value}, "
                        f"启用={'是' if self.enable_fallback else '否'}")
    
    def execute_fallback(self, input_path: Union[str, Path], 
    ...
    def _copy_original_strategy(self, input_path: Union[str, Path], 
                              output_path: Union[str, Path],
    ...
    def _minimal_masking_strategy(self, input_path: Union[str, Path], 
                                 output_path: Union[str, Path],
                                 context: Dict[str, Any]) -> FallbackResult:
        """最小掩码处理策略"""
        try:
    ...
    def _skip_processing_strategy(self, input_path: Union[str, Path], 
                                 output_path: Union[str, Path],
                                 context: Dict[str, Any]) -> FallbackResult:
        """跳过处理策略"""
        try:
    ...
    def _safe_mode_strategy(self, input_path: Union[str, Path], 
                           output_path: Union[str, Path],
                           context: Dict[str, Any]) -> FallbackResult:
        """安全模式处理策略"""
        try:
