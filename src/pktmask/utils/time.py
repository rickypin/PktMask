...
def format_duration_seconds(duration_seconds: float) -> str:
    ...
    minutes = int((duration_seconds % (SystemConstants.MINUTES_PER_HOUR * SystemConstants.SECONDS_PER_MINUTE)) // SystemConstants.SECONDS_PER_MINUTE)
...
def format_milliseconds_to_time(milliseconds: int) -> str:
    ...
    hours, remainder = divmod(total_seconds, SystemConstants.MINUTES_PER_HOUR * SystemConstants.SECONDS_PER_MINUTE)
