...
class GUIConsistentProcessor:
    ...
    @staticmethod
    def create_executor_from_gui(remove_dupes_checked: bool, 
    ...
    @staticmethod
    def validate_gui_options(remove_dupes_checked: bool,
                           anonymize_ips_checked: bool, 
                           mask_payloads_checked: bool) -> None:
    ...
    @staticmethod
    def get_gui_configuration_summary(remove_dupes_checked: bool,
                                    anonymize_ips_checked: bool,
                                    mask_payloads_checked: bool) -> str:
    ...
    def _process_single_file(self):
        ...
        try:
            ...
            self.progress_signal.emit(PipelineEvents.PIPELINE_START, {
                "total_files": 1,
                "input_path": str(self._base_dir)
            })
            
            # Emit file start signal
            self.progress_signal.emit(PipelineEvents.FILE_START, {
...
class GUIThreadingHelper:
    ...
    @staticmethod
    def create_threaded_executor(remove_dupes_checked: bool,
                               anonymize_ips_checked: bool,
                               mask_payloads_checked: bool,
                               base_dir: Union[str, Path], 
                               output_dir: Union[str, Path]) -> GUIServicePipelineThread:
