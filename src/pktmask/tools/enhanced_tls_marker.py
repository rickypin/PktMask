...
# Duplicate function definitions removed - all functions are already defined above
    ...
    if "tsv" in formats:
        ...
        with tsv_path.open("w", encoding="utf-8") as f:
            ...
            for hit in hits:
                ...
                f.write(
                    f"{hit['frame']}\t{protocol_types_str}\t{hit['num_records']}\t{strategies_str}\t{lengths_str}\t{hit['path']}\n"
                )
