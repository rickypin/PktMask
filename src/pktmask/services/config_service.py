...
class ConfigService:
    ...
    def create_options_from_cli_args(self,
                                   enable_dedup: bool = False,
                                   enable_anon: bool = False,
                                   enable_mask: bool = False,
                                   mask_mode: str = "enhanced",
                                   mask_protocol: str = "tls",
                                   tshark_path: Optional[str] = None) -> ProcessingOptions:
        """
        从CLI参数创建处理选项
    ...
    def create_options_from_gui(self,
                              dedup_checked: bool,
                              anon_checked: bool,
                              mask_checked: bool) -> ProcessingOptions:
        """
        从GUI状态创建处理选项
