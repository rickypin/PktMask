...
class ErrorEventData(BaseEventData):
    ...
    def __init__(self, **data):
        super().__init__(
            event_type=PipelineEvents.ERROR, 
...
class PipelineEventData(BaseModel):
    ...
    event_type: PipelineEvents = Field(..., description="事件类型")
    data: Union[
        PipelineStartData, PipelineEndData, SubdirStartData, SubdirEndData,
        FileStartData, FileEndData, StepStartData, StepEndData, StepSummaryData,
