...
def validate_complete_preservation(
    original_json: Path, masked_json: Path, target_types: List[int] = [20, 21, 22, 24]
) -> Dict[str, Any]:
...
def validate_protocol_type_detection(
    original_json: Path, target_types: List[int] = [20, 21, 22, 23, 24]
) -> Dict[str, Any]:
