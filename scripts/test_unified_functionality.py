...
from pktmask.services.config_service import get_config_service, build_config_from_cli_args, build_config_from_gui
...
class UnifiedFunctionalityTester:
    ...
    def test_cli_commands(self) -> bool:
        ...
        commands_to_test = [
            ...
            ["python", "-m", "pktmask", "info", str(self.temp_dir / "test_data"), "--format", "json"],
        ]
