...
class TestNewMaskPayloadStage:
    ...
    @patch('pktmask.core.pipeline.stages.mask_payload_v2.marker.tls_marker.TLSProtocolMarker')
    @patch('pktmask.core.pipeline.stages.mask_payload_v2.masker.payload_masker.PayloadMasker')
