...
class TestTLSFlowAnalyzer:
    ...
    def test_has_tls_content(self):
        ...
        # 不包含 TLS 内容的层
        layers_without_tls = {"tcp.payload": "deadbeef"}
...
class TestUtilityFunctions:
    ...
    def test_apply_type_filter(self):
        ...
        analysis_result = {
            ...
            "reassembled_messages": [{"content_type": 22}, {"content_type": 23}],
            "global_statistics": {"frames_containing_tls": 3, "tls_records_total": 2},
            "metadata": {"total_frames_with_tls": 3, "total_tls_records": 2},
        }
...
class TestIntegration:
    ...
    def test_main_function_success(self, mock_subprocess):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # 测试 summary-only 模式
            main(["--pcap", str(test_pcap), "--summary-only"])
