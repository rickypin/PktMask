...
from src.pktmask.core.strategy import (
    ...
    HierarchicalAnonymizationStrategy,
    ip_sort_key,
    _safe_hash,
    _generate_unique_segment,
...
class TestHierarchicalAnonymizationStrategy:
    ...
    def test_anonymize_packet_ipv4(self):
        ...
        # 手动设置映射
        strategy._ip_map = {"192.168.1.1": "10.0.0.100", "192.168.1.2": "10.0.0.101"}
...
class TestStrategyIntegration:
    ...
    def test_strategy_complete_workflow(self, temp_test_dir):
        ...
        ip_packets_modified = [
            modified
            for anon_packet, modified in anonymized_packets
            if anon_packet.haslayer(IP)
        ]
