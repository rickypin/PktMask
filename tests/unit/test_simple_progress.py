...
class TestCLIProgressHandler:
    ...
    def test_pipeline_start(self):
        ...
        with patch("builtins.print") as mock_print:
            handler.handle_progress(PipelineEvents.PIPELINE_START, {"total_files": 5})
    ...
    def test_file_start(self):
        ...
        with patch("builtins.print") as mock_print:
            handler.handle_progress(PipelineEvents.FILE_START, {"path": "test.pcap"})
    ...
    def test_step_summary_verbose(self):
        ...
        with patch("builtins.print") as mock_print:
            handler.handle_progress(
                ...
                {"step_name": "dedup", "packets_processed": 1000, "duration_ms": 150.5},
            )
    ...
    def test_error_event(self):
        ...
        with patch("builtins.print") as mock_print:
            handler.handle_progress(PipelineEvents.ERROR, {"message": "Test error"})
...
class TestCallbackCreation:
    ...
    def test_create_simple_progress_callback(self):
        ...
        with patch("builtins.print"):
            callback(
                PipelineEvents.STEP_SUMMARY,
                {"step_name": "test", "packets_processed": 100},
            )
